...
export async function fetchAdvancedMovies(options: { language?: string, platform?: string, genre?: string, year?: string, page?: number } = {}) {
  ...
  if (options.year && options.year !== "All") params.set("primary_release_year", options.year);
